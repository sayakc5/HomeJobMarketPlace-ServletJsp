...
/**
 * Servlet implementation class ListAllApplications
 */
@WebServlet("/ListAllApplications")
public class ListAllApplications extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			request.setAttribute("applications",servicelayer.getAllApplicationService());
			request.getRequestDispatcher("/WEB-INF/pages/DisplayApplications.jsp").forward(request,response);
